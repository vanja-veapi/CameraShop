...
namespace CameraShop.EfDataAccess.Migrations
{
    ...
    [Migration("20230809105156_Change of type in Camera table")]
    partial class ChangeoftypeinCameratable
    {
            ...
            modelBuilder.Entity("CameraShop.Domain.User", b =>
                {
                    ...
                    b.Property<string>("UniqueActivisonCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
